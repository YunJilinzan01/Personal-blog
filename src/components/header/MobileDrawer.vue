        ...
        <div class="p-6 flex flex-col gap-6">
          ...
          <nav class="flex flex-col gap-2">
            <router-link to="/" @click="closeMenu"
              class="px-4 py-3 rounded-xl hover:bg-black/5 dark:hover:bg-white/5 text-lg font-medium transition-colors">首页</router-link>
            <router-link to="/archives" @click="closeMenu"
              class="px-4 py-3 rounded-xl hover:bg-black/5 dark:hover:bg-white/5 text-lg font-medium transition-colors">归档</router-link>
            <router-link to="/about" @click="closeMenu"
              class="px-4 py-3 rounded-xl hover:bg-black/5 dark:hover:bg-white/5 text-lg font-medium transition-colors">关于我</router-link>
          </nav>
        </div>
      </div>
    </div>
