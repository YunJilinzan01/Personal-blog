<script setup>
import { usePostModal } from '@/composables/main/usePostModal'
...
const { showConfirm, form, handleClose, confirmCancel, confirmClose, handleSubmit } = usePostModal(emit)
</script>
...
<template>
  <Teleport to="body">
    <Transition enter-active-class="transition duration-300 ease-out" enter-from-class="opacity-0"
      ...
      <div v-if="show" class="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/40 backdrop-blur-md"
          ...
          <div class="relative w-full max-w-2xl flex items-center justify-center">
            ...
            <div
              ...
              <div class="p-6 max-h-[70vh] overflow-y-auto space-y-5 custom-scrollbar">
                <!-- 标题 -->
                <div class="space-y-2">
                  <label class="text-sm font-medium text-gray-700 dark:text-zinc-300 flex items-center gap-2">
                    标题
                  </label>
                  <input v-model="form.title" type="text" placeholder="给帖子起个亮眼的标题..."
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div class="space-y-2">
                    ...
                    <input v-model="form.tags" type="text" placeholder="Vue, 前端, 技巧"
                      class="w-full px-4 py-2.5 bg-gray-50/50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all dark:text-zinc-100" />
                  </div>
                </div>
                ...
                <div class="space-y-2">
                  ...
                  <input v-model="form.cover" type="text" placeholder="https://example.com/image.jpg"
                    class="w-full px-4 py-2.5 bg-gray-50/50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all dark:text-zinc-100" />
                </div>

                <!-- 正文 -->
                <div class="space-y-2">
                  <label class="text-sm font-medium text-gray-700 dark:text-zinc-300">正文内容 (支持 HTML)</label>
                  <textarea v-model="form.content" rows="8" placeholder="开始创作吧..."
                    class="w-full px-4 py-3 bg-gray-50/50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700 rounded-2xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all resize-none dark:text-zinc-100 custom-scrollbar"></textarea>
                </div>
              </div>
              ...
              <div
                ...
                <button @click="handleSubmit" :disabled="!form.title.trim() || !form.content.trim()"
