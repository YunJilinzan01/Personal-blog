...
import { usePostItem } from '@/composables/main/usePostItem'
...
<template>
  <article @click="goToDetail" :class="[
    ...
    <DeleteConfirmModal :show="showDeleteModal" :title="post.title" @close="showDeleteModal = false"
    ...
    <div :class="[
      ...
      <div>
        ...
        <!-- 文章元信息 -->
        <div class="flex flex-wrap items-center gap-3 text-sm text-gray-500 dark:text-zinc-400 mb-4">
          <!-- 日期 -->
          <div
      ...
      <div class="flex flex-wrap gap-2 mt-auto">
        <span v-for="tag in post.tags" :key="tag" @click.stop
