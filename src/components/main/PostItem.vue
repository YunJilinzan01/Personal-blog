...
<template>
  <article
    :class="[
      'relative p-6 rounded-2xl bg-white/80 backdrop-blur-md border border-white/[0.08] shadow-lg transition-all duration-300 overflow-hidden',
  ...
  >
    ...
    >
      <div>
        ...
        <div class="flex items-center gap-2 mb-4">
          <span class="w-1.5 h-6 bg-blue-500 rounded-full flex-shrink-0"></span>
          ...
          >
            ...
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              class="w-5 h-5 text-gray-400 group-hover/title:text-[#37a8ec] transition-colors"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              stroke-width="2.5"
        ...
        <div class="flex flex-wrap items-center gap-3 text-sm text-gray-500 mb-4">
          <!-- 日期 -->
          <div
            class="flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-blue-50 text-blue-600 border border-blue-100"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="w-4 h-4"
    ...
    <div
      v-else
      class="hidden md:flex w-14 h-40 rounded-xl bg-[#e0f1fe] border border-blue-100 hover:bg-[#c1e3fc] items-center justify-center text-blue-600 transition-all duration-300 flex-shrink-0 cursor-pointer group/arrow"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
