  ...
  >
    ...
    <form @submit.prevent="handleSubmit" class="mb-10 space-y-4">
      ...
      <textarea
        ...
        placeholder="说点什么吧..."
        required
        class="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-zinc-800/50 border border-gray-100 dark:border-zinc-700 focus:outline-none focus:ring-2 focus:ring-blue-500/50 dark:text-zinc-100 transition-all resize-none"
      ></textarea>
