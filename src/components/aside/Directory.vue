  ...
  >
    ...
    <div class="flex flex-wrap gap-2">
      <a
        ...
        class="text-gray-600 dark:text-zinc-400 px-3 font-bold py-2 bg-gray-100 dark:bg-zinc-800 rounded-lg text-sm hover:bg-gray-200 dark:hover:bg-zinc-700 transition-colors"
        >最新文章</a
      >
      <a
